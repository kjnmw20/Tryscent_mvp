...
import svgPaths from "../../imports/svg-tnt50ttznh";
import { placeOptions } from "../../utils/recommendation";
        ...
        <FixedButton 
          ...
          onNext={() => {
            if (selectedOption !== null) {
              sessionStorage.setItem("q4", placeOptions[selectedOption]);
            }
          }}
        />
      </div>
